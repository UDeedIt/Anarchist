...
object PermissionRegistry {
    fun getStandardPermissions(): List<PermissionFeature> =
        listOf(
            PermissionFeature(
                id = ID_NOTIFICATIONS,
    ...
    fun getSpecialPermissions(): List<PermissionFeature> =
        listOf(
            PermissionFeature(
                id = ID_EXACT_ALARM,
                title = "Exact Alarms",
            ...
            PermissionFeature(
                ...
                supportingRationale =
                    "Used to demonstrate system-level analytic access. " +
            ...
            PermissionFeature(
                ...
                isManualOnly = true,
                manualEnablementGuidance =
                    "1. Find 'Anarchist Demo' in the battery optimization list.\n" +
                        "2. Select 'Don't optimize'.\n3. Confirm to allow persistent background activity.",
            ),
        )

    fun getGroupedPermissions(): List<PermissionFeature> =
        listOf(
            PermissionFeature(
                id = ID_MEDIA_BUNDLE,
            ...
            PermissionFeature(
                ...
                supportingRationale =
                    "Demonstrates the library's ability to consolidate " +
